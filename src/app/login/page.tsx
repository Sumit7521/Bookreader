      ...
      <div className="w-full max-w-md z-10">
        <Card className="border-stone-200 dark:border-stone-800 shadow-xl shadow-amber-900/5 dark:shadow-black/50 bg-white/80 dark:bg-stone-900/80 backdrop-blur-sm">
          <CardHeader className="space-y-3 text-center pb-6">
            <CardTitle className="text-3xl font-serif text-stone-800 dark:text-stone-100">Welcome Back</CardTitle>
            <CardDescription className="text-stone-500 dark:text-stone-400">
              Return to your cozy reading corner
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="text-center text-sm text-stone-500 dark:text-stone-400">
              ...
              <Link href="/register" className="underline underline-offset-4 hover:text-stone-800 dark:hover:text-stone-100 transition-colors">
                Register here
              </Link>
            </div>
          </CardContent>
